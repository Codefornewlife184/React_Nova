    ...
    <>
        ...
        <div className="main-header" >
          <Container fluid className="main-header-container">
            <Row className="align-items-center">
              ...
              <Col xs={6} lg={9} className="d-flex justify-content-end">
                <Navbar 
                  expand="lg" 
                  expanded={expanded} 
                  onToggle={toggleNav}
                  className="main-nav py-2 px-0 w-100"
                  bg="transparent"
                  style={{ '--bs-navbar-toggler-bg': 'transparent' }}
                >
                  <Navbar.Toggle aria-controls="basic-navbar-nav" className="border-0 text-white ms-auto" />
                  <Navbar.Collapse 
                    id="basic-navbar-nav" 
                  ...
                  >
                    <Nav className="ms-auto">
                      ...
                      <Nav.Link as={Link} to="/contact" onClick={handleClick} className="text-white">İletişim</Nav.Link>
                    </Nav>
                  </Navbar.Collapse>
                </Navbar>
              </Col>
      ...
      <style>{`
        ...
        /* Örneğin, ürün listeleme sayfası için responsive CSS (önceki konuşmalardan) */
         ...
         /* Adjustments for Logo Left, Menu Right Layout */
         ...
         /* Ensure enough space for content below fixed header */
         body {
            padding-top: 70px;
         }
      `}</style>

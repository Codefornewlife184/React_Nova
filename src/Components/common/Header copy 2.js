              ...
              <Col xs={12} className="d-flex justify-content-between align-items-center">
                ...
                <div className="language-selector d-flex align-items-center">
                  <button 
                    ...
                    style={{
                      backgroundColor: i18n.language === 'tr' ? '#beab74' : 'transparent',
                  ...
                  <button 
                    ...
                    style={{
                      backgroundColor: i18n.language === 'en' ? '#beab74' : 'transparent',
                      border: '1px solid #beab74',
            ...
            <Row className="align-items-center">
              <Col xs={12}>
                <div className="header-main-row align-items-center">
                  {/* Logo */}
                  <Link to="/" onClick={handleClick} className="d-inline-block header-logo-link">
                    <img src="/assets/images/nova-logo.webp" alt="logo" style={{ maxHeight: '100px', padding:"5px"}} />
                  </Link>
                  ...
                  >
                    ...
                    >
                      <Nav className="mx-auto">
                        <Nav.Link as={Link} to={getLocalizedPath("home", language)} onClick={handleClick} className="text-dark me-3">{navLabels.home}</Nav.Link>
                        <Nav.Link as={Link} to={getLocalizedPath("about", language)} onClick={handleClick} className="text-dark me-3">{navLabels.about}</Nav.Link>
                        <Nav.Link as={Link} to={getLocalizedPath("product", language)} onClick={handleClick} className="text-dark me-3">
                          {navLabels.product}
                        </Nav.Link>
                        <NavDropdown
                        ...
                        >
                          ...
                          <NavDropdown.Item as={Link} to={getLocalizedPath("registration", language)} onClick={handleClick}>
                            {navLabels.registration}
                          </NavDropdown.Item>
                          <NavDropdown.Item as={Link} to={getLocalizedPath("faq", language)} onClick={handleClick}>
                            {navLabels.faq}
                          </NavDropdown.Item>
                          <NavDropdown.Item as={Link} to={getLocalizedPath("usefulLinks", language)} onClick={handleClick}>
                            {navLabels.usefulLinks}
                          </NavDropdown.Item>
                          <NavDropdown.Item as={Link} to={getLocalizedPath("vehicles", language)} onClick={handleClick}>
                            {navLabels.vehicles}
                          </NavDropdown.Item>
                        </NavDropdown>
                        <Nav.Link as={Link} to={getLocalizedPath("contact", language)} onClick={handleClick} className="text-dark me-3">{navLabels.contact}</Nav.Link>
                      </Nav>
                      <div className="mobile-contact-panel d-xl-none">
                        <a
                          href="tel:+902242672424"

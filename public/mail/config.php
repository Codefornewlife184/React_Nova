...
define('SMTP_PASS', getenv('SMTP_PASS') ?: '9Xi6Qxgx86');
...
define('ALLOW_ORIGINS', $origins ? explode(',', $origins) : ['https://aypinotomat.com','http://aypinotomat.com','http://localhost:3000']);
